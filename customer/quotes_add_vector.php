    ...
    <div class="container-fluid">
      ...
      <div class="row page-titles">
          <div class="col-md-5 align-self-center">
              <h3 class="text-themecolor">Vector Quote</h3>
              <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                  <li class="breadcrumb-item"><a href="vectorquotes.php">Vector Quotes</a></li>
           ...
           <div class="card">
             <div class="card-body">
               <h4 class="card-title">VECTOR QUOTE</h4>
               <h6 class="card-subtitle">Get the quote for Vector Design</h6>

...
.form-material .form-control, .form-material .form-control.focus, .form-material .form-control:focus{
    background-image: linear-gradient(#f1b908, #f1b908), linear-gradient(#e9edf2, #e9edf2);
    border: 0 none;
    border-radius: 0;
    box-shadow: none;
    float: none;
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="../assets/images/logo-text-2.png" alt="homepage" class="dark-logo" width="190"/>
                         <!-- Light Logo text -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" aria-expanded="false"> <i class="flag-icon flag-icon-us"></i></a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- Profile -->
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user" class="" /> <span class="hidden-md-down">Sales Executive &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="salesindex.php"><i class="ti-user"></i> My Dashboard</a></li>
                                    <li><a href="customerindex.php"><i class="ti-wallet"></i> Customer Dashboard</a></li>
                                    <li><a href="index.php"><i class="ti-user"></i> Admin Dashboard</a></li>
                                    <li><a href="index.php"><i class="ti-wallet"></i> Admin Dashboard</a></li>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="customerorders.php">View All</a></li>
                            <li> <a class="has-arrow" href="#" aria-expanded="false">Place New Order</a>
                                <ul aria-expanded="false" class="collapse">
                                  <li><a href="adddigitizingorder.php">Digitizing Order</a></li>
                                  <li><a href="addvectororder.php">Vector Order</a></li>
                                </ul>
                            </li>
                        </ul>
                        </li>
                          ...
                          <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="icon-Double-Circle"></i><span class="hide-menu">Quotes</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="quotes.php">View Quotes</a></li>
                                <li> <a class="has-arrow" href="#" aria-expanded="false">Request a Quote</a>
                                    <ul aria-expanded="false" class="collapse">
                                      <li><a href="adddigitizingquote.php">Digitizing Quote</a></li>
                                      <li><a href="addvectorquote.php">Vector Quote</a></li>
                                    </ul>
                                </li>
                            </ul>
                          </li>
                              ...
                              <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li> <a class="has-arrow" href="#" aria-expanded="false">Payments</a>
                                        <ul aria-expanded="false" class="collapse">
                                          <li><a href="customersinvoicelog.php">Invoice Logs</a></li>
                                          <li><a href="customerspaid.php">Paid Invoice</a></li>
                                          <li><a href="customersunpaid.php">Unpaid Invoice</a></li>
                                          <li><a href="customersinvoicegenerate.php">Generate Invoice</a></li>
                                        </ul>
                                    </li>
                                </ul>
                              </li>
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="icon-Talk-Man" aria-hidden="true"></i><span class="hide-menu">Employees</span></a>
                              ...
                              <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li> <a class="has-arrow" href="#" aria-expanded="false">Payments</a>
                                        <ul aria-expanded="false" class="collapse">
                                            <li><a href="employeespaid.php">Paid Invoice</a></li>
                                            <li><a href="employeesunpaid.php">Unpaid Invoice</a></li>
                                            <li><a href="employeesinvoicegenerate.php">Pay to Workers</a></li>
                                        </ul>
                                    </li>
                                </ul>
                              </li>

                            <li class="nav-small-cap">--- DEBIT</li>
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-file-pdf-o"></i><span class="hide-menu">Invoices</span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="invoice.php">View Invoices</a></li>
                                    <li><a href="app-chat.html">Generate Invoice</a></li>
                                </ul>
                            </li>
                    </ul>
                </nav>

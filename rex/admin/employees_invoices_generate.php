...
<!-- Breadcrumb Start -->
      <div class="row page-titles">
          <div class="col-md-12 align-self-center">
              <h3 class="text-themecolor">Employees Invoice Generate</h3>
              <ol class="breadcrumb">
             ...
             <h4 class="card-title">Search Employee</h4>
                ...
                <form method="post" class="row" action="">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" name="contact" class="form-control" value="farhan017" disabled>
                  </div>
                  <div class="form-group col-md-6">
                      <label>Email</label>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-3 col-xlg-6">
                ...
                <h6 class="card-subtitle">mohdfarhan018@gmail.com</h6>
              </div>
              <!-- Column -->

                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user" class="" /> <span class="hidden-md-down">Designer &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="designerindex.php"><i class="ti-user"></i> My Dashboard</a></li>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="designerorders.php">View All</a></li>
                            <li><a href="designercompletedorders.php">Completed Orders</a></li>
                            <li><a href="designerpendingorders.php">Pending Orders</a></li>
                        </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-file-pdf-o"></i><span class="hide-menu">My Business</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="designerinvoicelog.php">View Invoices</a></li>
                                <li><a href="designerearnings.php">My Earnings</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
